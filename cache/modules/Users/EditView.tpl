...
{capture name="label" assign="label"}{sugar_translate label='LBL_EXTENSION' module='Users'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
addToValidate('EditView', 'logged_in', 'bool', false,'{/literal}{sugar_translate label='LBL_LOGGED_IN' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'availability', 'bool', false,'{/literal}{sugar_translate label='LBL_AVAILABILITY' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'extension', 'varchar', false,'{/literal}{sugar_translate label='LBL_EXTENSION' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'voip_access', 'enum', true,'{/literal}{sugar_translate label='LBL_VOIP_ACCESS' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'allow_phone_mobile', 'bool', true,'{/literal}{sugar_translate label='LBL_ALLOW_PHONE_MOBILE' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'allow_phone_work', 'bool', true,'{/literal}{sugar_translate label='LBL_ALLOW_PHONE_WORK' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'allow_phone_home', 'bool', true,'{/literal}{sugar_translate label='LBL_ALLOW_PHONE_HOME' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'allow_phone_other', 'bool', true,'{/literal}{sugar_translate label='LBL_ALLOW_PHONE_OTHER' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'allow_browser', 'bool', true,'{/literal}{sugar_translate label='LBL_ALLOW_BROWSER' module='Users' for_js=true}{literal}' );
