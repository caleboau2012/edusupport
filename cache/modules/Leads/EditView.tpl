...
{capture name="label" assign="label"}{sugar_translate label='LBL_SALES_STAGE' module='Leads'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_INTEREST' module='Leads'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.interest_c.name}" 
id="{$fields.interest_c.name}" 
title=''       
>
{if isset($fields.interest_c.value) && $fields.interest_c.value != ''}
{html_options options=$fields.interest_c.options selected=$fields.interest_c.value}
{else}
{html_options options=$fields.interest_c.options selected=$fields.interest_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.interest_c.options }
{capture name="field_val"}{$fields.interest_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.interest_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.interest_c.name}" 
id="{$fields.interest_c.name}" 
title=''          
>
{if isset($fields.interest_c.value) && $fields.interest_c.value != ''}
...
<input
id="{$fields.interest_c.name}-input"
name="{$fields.interest_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.interest_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.interest_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.interest_c.name}-input', '{$fields.interest_c.name}');sync_{$fields.interest_c.name}()"><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
{literal}
<script>
SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
...
{literal}
(function (){
var selectElem = document.getElementById("{/literal}{$fields.interest_c.name}{literal}");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:''};
//get default
...
YUI().use("autocomplete", "autocomplete-filters", "autocomplete-highlighters", "node","node-event-simulate", function (Y) {
{/literal}
SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.interest_c.name}-input');
SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.interest_c.name}-image');
SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.interest_c.name}');
{literal}
function SyncToHidden(selectme){
var selectElem = document.getElementById("{/literal}{$fields.interest_c.name}{literal}");
var doSimulateChange = false;
...
//global variable 
sync_{/literal}{$fields.interest_c.name}{literal} = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("{/literal}{$fields.interest_c.name}{literal}");
...
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.simulate('keyup');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.interest_c.name}-input{literal}'))
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("{/literal}{$fields.interest_c.name}{literal}", syncFromHiddenToWidget);
{/literal}
SUGAR.AutoComplete.{$ac_key}.minQLen = 0;
SUGAR.AutoComplete.{$ac_key}.queryDelay = 0;
SUGAR.AutoComplete.{$ac_key}.numOptions = {$field_options|@count};
...
{capture name="label" assign="label"}{sugar_translate label='LBL_BUYING_POWER' module='Leads'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.buying_power_c.name}" 
id="{$fields.buying_power_c.name}" 
title='Can the lead afford to pay for the programme?'       
>
{if isset($fields.buying_power_c.value) && $fields.buying_power_c.value != ''}
{html_options options=$fields.buying_power_c.options selected=$fields.buying_power_c.value}
{else}
{html_options options=$fields.buying_power_c.options selected=$fields.buying_power_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.buying_power_c.options }
{capture name="field_val"}{$fields.buying_power_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.buying_power_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.buying_power_c.name}" 
id="{$fields.buying_power_c.name}" 
title='Can the lead afford to pay for the programme?'          
>
{if isset($fields.buying_power_c.value) && $fields.buying_power_c.value != ''}
...
<input
id="{$fields.buying_power_c.name}-input"
name="{$fields.buying_power_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.buying_power_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.buying_power_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.buying_power_c.name}-input', '{$fields.buying_power_c.name}');sync_{$fields.buying_power_c.name}()"><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
{literal}
<script>
SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
...
{literal}
(function (){
var selectElem = document.getElementById("{/literal}{$fields.buying_power_c.name}{literal}");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:''};
//get default
...
YUI().use("autocomplete", "autocomplete-filters", "autocomplete-highlighters", "node","node-event-simulate", function (Y) {
{/literal}
SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.buying_power_c.name}-input');
SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.buying_power_c.name}-image');
SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.buying_power_c.name}');
{literal}
function SyncToHidden(selectme){
var selectElem = document.getElementById("{/literal}{$fields.buying_power_c.name}{literal}");
var doSimulateChange = false;
...
//global variable 
sync_{/literal}{$fields.buying_power_c.name}{literal} = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("{/literal}{$fields.buying_power_c.name}{literal}");
...
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.simulate('keyup');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.buying_power_c.name}-input{literal}'))
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("{/literal}{$fields.buying_power_c.name}{literal}", syncFromHiddenToWidget);
{/literal}
SUGAR.AutoComplete.{$ac_key}.minQLen = 0;
SUGAR.AutoComplete.{$ac_key}.queryDelay = 0;
SUGAR.AutoComplete.{$ac_key}.numOptions = {$field_options|@count};
...
{capture name="label" assign="label"}{sugar_translate label='LBL_INTENDED_COURSE_OF_STUDY' module='Leads'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{/if}  
<input type='text' name='{$fields.intended_course_of_study_c.name}' 
id='{$fields.intended_course_of_study_c.name}' size='30' 
maxlength='255' 
value='{$value}' title='The intended course of study of the lead'      >
</tr>
{/capture}
{if $fieldsUsed > 0 }
{$tableRow}
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.reason_c.name}" 
id="{$fields.reason_c.name}" 
title='The reason the field was closed as lost'       
>
{if isset($fields.reason_c.value) && $fields.reason_c.value != ''}
{html_options options=$fields.reason_c.options selected=$fields.reason_c.value}
{else}
{html_options options=$fields.reason_c.options selected=$fields.reason_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.reason_c.options }
{capture name="field_val"}{$fields.reason_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.reason_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.reason_c.name}" 
id="{$fields.reason_c.name}" 
title='The reason the field was closed as lost'          
>
{if isset($fields.reason_c.value) && $fields.reason_c.value != ''}
...
<input
id="{$fields.reason_c.name}-input"
name="{$fields.reason_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.reason_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.reason_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.reason_c.name}-input', '{$fields.reason_c.name}');sync_{$fields.reason_c.name}()"><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
{literal}
<script>
SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
...
{literal}
(function (){
var selectElem = document.getElementById("{/literal}{$fields.reason_c.name}{literal}");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:''};
//get default
...
YUI().use("autocomplete", "autocomplete-filters", "autocomplete-highlighters", "node","node-event-simulate", function (Y) {
{/literal}
SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.reason_c.name}-input');
SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.reason_c.name}-image');
SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.reason_c.name}');
{literal}
function SyncToHidden(selectme){
var selectElem = document.getElementById("{/literal}{$fields.reason_c.name}{literal}");
var doSimulateChange = false;
...
//global variable 
sync_{/literal}{$fields.reason_c.name}{literal} = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("{/literal}{$fields.reason_c.name}{literal}");
...
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.simulate('keyup');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.reason_c.name}-input{literal}'))
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("{/literal}{$fields.reason_c.name}{literal}", syncFromHiddenToWidget);
{/literal}
SUGAR.AutoComplete.{$ac_key}.minQLen = 0;
SUGAR.AutoComplete.{$ac_key}.queryDelay = 0;
SUGAR.AutoComplete.{$ac_key}.numOptions = {$field_options|@count};
...
addToValidate('EditView', 'buying_power_c', 'enum', false,'{/literal}{sugar_translate label='LBL_BUYING_POWER' module='Leads' for_js=true}{literal}' );
...
addToValidate('EditView', 'intended_course_of_study_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_INTENDED_COURSE_OF_STUDY' module='Leads' for_js=true}{literal}' );
addToValidate('EditView', 'interest_c', 'enum', false,'{/literal}{sugar_translate label='LBL_INTEREST' module='Leads' for_js=true}{literal}' );
addToValidate('EditView', 'reason_c', 'enum', false,'{/literal}{sugar_translate label='LBL_REASON' module='Leads' for_js=true}{literal}' );
addToValidate('EditView', 'sales_stage_c', 'enum', false,'{/literal}{sugar_translate label='LBL_SALES_STAGE' module='Leads' for_js=true}{literal}' );
...
addToValidateBinaryDependency('EditView', 'modified_by_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Leads' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_MODIFIED_NAME' module='Leads' for_js=true}{literal}', 'modified_user_id' );
