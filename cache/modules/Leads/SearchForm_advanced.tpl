...
{html_options id='lead_source_advanced' name='lead_source_advanced[]' options=$fields.lead_source_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.lead_source_advanced.value}
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='sales_stage_c_advanced'>{sugar_translate label='LBL_SALES_STAGE' module='Leads'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
<input autocomplete="off" type="text" name="range_{$id}" id="range_{$id}" value='{if empty($smarty.request.range_date_modified_advanced) && !empty($smarty.request.date_modified_advanced)}{$smarty.request.date_modified_advanced}{else}{$smarty.request.range_date_modified_advanced}{/if}' title=''   size="11" style="width:100px !important;">
{capture assign="other_attributes"}alt="{$APP.LBL_ENTER_DATE}" style="position:relative; top:6px" border="0" id="{$id}_trigger"{/capture}
{sugar_getimage name="jscalendar" ext=".gif" other_attributes="$other_attributes"}
<script type="text/javascript">
Calendar.setup ({ldelim}
...
<input autocomplete="off" type="text" name="start_range_{$id}" id="start_range_{$id}" value='{$smarty.request.start_range_date_modified_advanced }' title=''  tabindex='' size="11" style="width:100px !important;">
{capture assign="other_attributes"}align="absmiddle" border="0" id="start_range_{$id}_trigger"{/capture}
{sugar_getimage name="jscalendar" ext=".gif" alt="$APP.LBL_ENTER_DATE other_attributes=$other_attributes"}
<script type="text/javascript">
Calendar.setup ({ldelim}
...
{$APP.LBL_AND}
{assign var=date_value value=$fields.date_modified_advanced.value }
<input autocomplete="off" type="text" name="end_range_{$id}" id="end_range_{$id}" value='{$smarty.request.end_range_date_modified_advanced }' title=''  tabindex='' size="11" style="width:100px !important;" maxlength="10">
{capture assign="other_attributes"}align="absmiddle" border="0" id="end_range_{$id}_trigger"{/capture}
{sugar_getimage name="jscalendar" ext=".gif" alt="$APP.LBL_ENTER_DATE other_attributes=$other_attributes"}
<script type="text/javascript">
Calendar.setup ({ldelim}
...
<input type='text' name='{$fields.phone_mobile_advanced.name}' id='{$fields.phone_mobile_advanced.name}' size='30' maxlength='100' value='{$value}' title='' tabindex=''	  class="phone" >
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='reason_c_advanced'>{sugar_translate label='LBL_REASON' module='Leads'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
{html_options id='reason_c_advanced' name='reason_c_advanced[]' options=$fields.reason_c_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.reason_c_advanced.value}
   	   	</td>
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='interest_c_advanced'>{sugar_translate label='LBL_INTEREST' module='Leads'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
{html_options id='interest_c_advanced' name='interest_c_advanced[]' options=$fields.interest_c_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.interest_c_advanced.value}
   	   	</td>
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='intended_course_of_study_c_advanced'>{sugar_translate label='LBL_INTENDED_COURSE_OF_STUDY' module='Leads'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
{if strlen($fields.intended_course_of_study_c_advanced.value) <= 0}
{assign var="value" value=$fields.intended_course_of_study_c_advanced.default_value }
{else}
{assign var="value" value=$fields.intended_course_of_study_c_advanced.value }
{/if}  
<input type='text' name='{$fields.intended_course_of_study_c_advanced.name}' 
    id='{$fields.intended_course_of_study_c_advanced.name}' size='30' 
    maxlength='255' 
