...
{/if}  
<input type='text' name='{$fields.matric_number_c.name}' 
id='{$fields.matric_number_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
...
maxlength='255' 
value='{$value}' title='Source of Account'      >
...
{/if}  
<input type='text' name='{$fields.how_c.name}' 
id='{$fields.how_c.name}' size='30' 
maxlength='255' 
value='{$value}' title='How the customer heard about us'      >
</tr>
{/capture}
{if $fieldsUsed > 0 }
{$tableRow}
...
addToValidate('EditView', 'how_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_HOW' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'matric_number_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_MATRIC_NUMBER' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'source_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_SOURCE' module='Accounts' for_js=true}{literal}' );
