...
addToValidate('form_QuickCreate_Accounts', 'how_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_HOW' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'matric_number_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_MATRIC_NUMBER' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'source_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_SOURCE' module='Accounts' for_js=true}{literal}' );
