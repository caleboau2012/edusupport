...
<?php endif; ?>
<td valign="top" id='location_c_label' width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_LOCATION','module' => 'Cases'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php if (strlen ( $this->_tpl_vars['fields']['location_c']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['location_c']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['location_c']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['location_c']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['location_c']['name']; ?>
' size='30' 
maxlength='255' 
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='comm_channel_c_label' width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_COMM_CHANNEL','module' => 'Cases'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php if (! isset ( $this->_tpl_vars['config']['enable_autocomplete'] ) || $this->_tpl_vars['config']['enable_autocomplete'] == false): ?>
<select name="<?php echo $this->_tpl_vars['fields']['comm_channel_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['comm_channel_c']['name']; ?>
" 
title=''       
>
<?php if (isset ( $this->_tpl_vars['fields']['comm_channel_c']['value'] ) && $this->_tpl_vars['fields']['comm_channel_c']['value'] != ''):  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['comm_channel_c']['options'],'selected' => $this->_tpl_vars['fields']['comm_channel_c']['value']), $this);?>

<?php else:  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['comm_channel_c']['options'],'selected' => $this->_tpl_vars['fields']['comm_channel_c']['default']), $this);?>
...
<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['comm_channel_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['comm_channel_c']['name']; ?>
" 
title=''          
...
id="<?php echo $this->_tpl_vars['fields']['comm_channel_c']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['comm_channel_c']['name']; ?>
-input"
size="30"
value="<?php echo ((is_array($_tmp=$this->_tpl_vars['field_val'])) ? $this->_run_mod_handler('lookup', true, $_tmp, $this->_tpl_vars['field_options']) : smarty_modifier_lookup($_tmp, $this->_tpl_vars['field_options'])); ?>
"
...
" id="<?php echo $this->_tpl_vars['fields']['comm_channel_c']['name']; ?>
-image"></button><button type="button"
id="btn-clear-<?php echo $this->_tpl_vars['fields']['comm_channel_c']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['comm_channel_c']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['comm_channel_c']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['comm_channel_c']['name']; ?>
()"><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-clear.png"), $this);?>
"></button>
</span>
<?php echo '
...
<?php echo '
(function (){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['comm_channel_c']['name'];  echo '");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:\'\'};
//get default
...
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['comm_channel_c']['name']; ?>
-input');
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['comm_channel_c']['name']; ?>
-image');
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['comm_channel_c']['name']; ?>
');
<?php echo '
function SyncToHidden(selectme){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['comm_channel_c']['name'];  echo '");
...
//global variable 
sync_';  echo $this->_tpl_vars['fields']['comm_channel_c']['name'];  echo ' = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['comm_channel_c']['name'];  echo '");
...
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.simulate(\'keyup\');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById(\'';  echo $this->_tpl_vars['fields']['comm_channel_c']['name']; ?>
-input<?php echo '\'))
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.set(\'value\',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("';  echo $this->_tpl_vars['fields']['comm_channel_c']['name'];  echo '", syncFromHiddenToWidget);
'; ?>
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'Cases'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<td valign="top" id='referred_by_c_label' width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_REFERRED_BY','module' => 'Cases'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php if (strlen ( $this->_tpl_vars['fields']['referred_by_c']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['referred_by_c']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['referred_by_c']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['referred_by_c']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['referred_by_c']['name']; ?>
' size='30' 
maxlength='255' 
value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='update_text_label' width='12.5%' scope="col">
...
<td valign="top" id='internal_label' width='12.5%' scope="col">
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='case_update_form_label' width='12.5%' scope="col">
...
addToValidate(\'EditView\', \'comm_channel_c\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_COMM_CHANNEL','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'location_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_LOCATION','module' => 'Cases','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'referred_by_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_REFERRED_BY','module' => 'Cases','for_js' => true), $this); echo '\' );
...
addToValidateBinaryDependency(\'EditView\', \'created_by_name\', \'alpha\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'Cases','for_js' => true), $this); echo ': ';  echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'Cases','for_js' => true), $this); echo '\', \'created_by\' );
