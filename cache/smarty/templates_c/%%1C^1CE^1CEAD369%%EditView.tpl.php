...
<h4><?php echo $this->_tpl_vars['MOD']['LBL_AOR_CONDITIONS_SUBPANEL_TITLE']; ?>
</h4>
<div id="conditionLines"  style="min-height: 50px;">
</div>
</div>
<div class="edit view edit508" id="detailpanel_charts" style="width: 80%; float: right;">
<h4><?php echo $this->_tpl_vars['MOD']['LBL_AOR_CHARTS_SUBPANEL_TITLE']; ?>
</h4>
<div id="chartLines">
<table>
