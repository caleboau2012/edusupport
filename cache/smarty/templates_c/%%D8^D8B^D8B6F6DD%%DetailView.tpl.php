<?php /* Smarty version 2.6.11, created on 2015-12-09 13:39:40
         compiled from cache/modules/Accounts/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/Accounts/DetailView.tpl', 33, false),array('function', 'counter', 'cache/modules/Accounts/DetailView.tpl', 38, false),array('function', 'sugar_getimagepath', 'cache/modules/Accounts/DetailView.tpl', 41, false),array('function', 'sugar_translate', 'cache/modules/Accounts/DetailView.tpl', 44, false),array('function', 'sugar_phone', 'cache/modules/Accounts/DetailView.tpl', 86, false),array('function', 'sugar_ajax_url', 'cache/modules/Accounts/DetailView.tpl', 450, false),array('modifier', 'strip_semicolon', 'cache/modules/Accounts/DetailView.tpl', 58, false),array('modifier', 'substr', 'cache/modules/Accounts/DetailView.tpl', 131, false),array('modifier', 'to_url', 'cache/modules/Accounts/DetailView.tpl', 133, false),array('modifier', 'escape', 'cache/modules/Accounts/DetailView.tpl', 257, false),array('modifier', 'url2html', 'cache/modules/Accounts/DetailView.tpl', 257, false),array('modifier', 'nl2br', 'cache/modules/Accounts/DetailView.tpl', 257, false),)), $this); ?>
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['matric_number_c']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_MATRIC_NUMBER','module' => 'Accounts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td class="" type="varchar" field="matric_number_c" width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['matric_number_c']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>


<?php if (strlen ( $this->_tpl_vars['fields']['matric_number_c']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['matric_number_c']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['matric_number_c']['value']);  endif; ?> 
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['matric_number_c']['name']; ?>
"><?php echo $this->_tpl_vars['fields']['matric_number_c']['value']; ?>
</span>
<?php endif; ?>
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['jjwg_maps_address_c']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_JJWG_MAPS_ADDRESS','module' => 'Accounts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td class="" type="varchar" field="jjwg_maps_address_c" width='37.5%' colspan='3' >
<?php if (! $this->_tpl_vars['fields']['jjwg_maps_address_c']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['billing_address_state']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_BILLING_ADDRESS_STATE','module' => 'Accounts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td class="" type="varchar" field="billing_address_state" width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['billing_address_state']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
...
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['billing_address_state']['name']; ?>
"><?php echo $this->_tpl_vars['fields']['billing_address_state']['value']; ?>
</span>
<?php endif; ?>
</td>
</tr>
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['source_c']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_SOURCE','module' => 'Accounts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['how_c']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_HOW','module' => 'Accounts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td class="" type="varchar" field="how_c" width='37.5%' colspan='3' >
<?php if (! $this->_tpl_vars['fields']['how_c']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>


<?php if (strlen ( $this->_tpl_vars['fields']['how_c']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['how_c']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['how_c']['value']);  endif; ?> 
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['how_c']['name']; ?>
"><?php echo $this->_tpl_vars['fields']['how_c']['value']; ?>
</span>
<?php endif; ?>
</td>
</tr>
