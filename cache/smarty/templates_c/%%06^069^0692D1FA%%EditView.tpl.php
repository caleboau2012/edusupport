...
<td valign="top" id='extension_label' width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_EXTENSION','module' => 'Users'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
addToValidate(\'EditView\', \'logged_in\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_LOGGED_IN','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'availability\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_AVAILABILITY','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'extension\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_EXTENSION','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'voip_access\', \'enum\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_VOIP_ACCESS','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'allow_phone_mobile\', \'bool\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ALLOW_PHONE_MOBILE','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'allow_phone_work\', \'bool\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ALLOW_PHONE_WORK','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'allow_phone_home\', \'bool\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ALLOW_PHONE_HOME','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'allow_phone_other\', \'bool\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ALLOW_PHONE_OTHER','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'allow_browser\', \'bool\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ALLOW_BROWSER','module' => 'Users','for_js' => true), $this); echo '\' );
