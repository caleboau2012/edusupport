<?php /* Smarty version 2.6.11, created on 2015-11-09 13:47:49
         compiled from cache/modules/Leads/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'cat', 'cache/modules/Leads/DetailView.tpl', 7, false),array('modifier', 'strip_semicolon', 'cache/modules/Leads/DetailView.tpl', 95, false),array('modifier', 'escape', 'cache/modules/Leads/DetailView.tpl', 2188, false),array('modifier', 'url2html', 'cache/modules/Leads/DetailView.tpl', 2188, false),array('modifier', 'nl2br', 'cache/modules/Leads/DetailView.tpl', 2188, false),array('modifier', 'strip_tags', 'cache/modules/Leads/DetailView.tpl', 2271, false),array('function', 'sugar_include', 'cache/modules/Leads/DetailView.tpl', 70, false),array('function', 'counter', 'cache/modules/Leads/DetailView.tpl', 75, false),array('function', 'sugar_getimagepath', 'cache/modules/Leads/DetailView.tpl', 78, false),array('function', 'sugar_translate', 'cache/modules/Leads/DetailView.tpl', 81, false),array('function', 'sugar_phone', 'cache/modules/Leads/DetailView.tpl', 2090, false),)), $this); ?>
...
<td class="" type="varchar" field="first_name" width='37.5%' colspan='3' >
...
<td class="" type="varchar" field="last_name" width='37.5%'  >
			...
			else
			{
				setupTimer = setInterval(function() {					
					...
					<?php echo '
						...
						var Setup_res = Twilio.Device.setup("';   echo $token;   echo '",{debug : true}); 
					...
					<?php echo '
						var Setup_res = Twilio.Device.setup("';   echo $token;   echo '"); 																	
		...
		*/
		...
		{			
			...
			if(source_numbers.source == "false")
			{
				...
				html_radio += \'<li ><a href="';   print $GLOBALS["sugar_config"]["site_url"]."/index.php?module=rolus_Twilio_Account";   echo '" target="_blank" style="display:block;margin:0px;padding:0px;color:#333;font:normal 24px/32px Arial, Helvetica, sans-serif;" ><h3>Configure Number!</h3></a></li>\';
				html_radio += \'</ul>\';		
			}
			...
			else
			{
				...
				else
				{
					...
					<?php  
					 ...
					 ?>
					<?php echo '			
					dest_number = ';   echo $twilio_country_code;  echo '+dest_num;				
		...
		*/
		function init_outbound_call(call_response)
		{
			...
			else
			{
				...
				{	
					related_id = "';  echo $_REQUEST['record'];  echo '";
					related_module = "';  echo $_REQUEST['module'];  echo '";
					call_sid = Call_Sid;
		...
		function call_making_with_verified_twilio_creds(is_verified)
		{
			if(is_verified == true) // initiate call only when twili call account settings are correct 
			{
				...
				else
				{
					...
					related_id = "';   echo $_REQUEST['record'];  echo '";//current module\'s record id
					related_module = "';  echo $_REQUEST['module'];  echo '";				
					$.ajax({
						url:"index.php",
						type:"POST",
			...
			$.ajax({
				...
				{					
					...
					else //means final call status has updated n now display to caller or user
					{
						...
						$("#outbound_call_detail").attr({href:"';  echo $GLOBALS['sugar_config']['site_url'];  echo '"+"/index.php?action=DetailView&module=Calls&record="+ref_call_id});
		...
		*/
		function send_sms(destination,init_plugin_obj)
		{
			...
			';   
			  ...
			  echo '
			var source_num ="';  echo $source_number;  echo '";
...
<td class="" type="enum" field="sales_stage_c" width='37.5%'  >
...
<td class="" type="text" field="lead_source_description" width='37.5%'  >
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['interest_c']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_INTEREST','module' => 'Leads'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td class="" type="enum" field="interest_c" width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['interest_c']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['buying_power_c']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_BUYING_POWER','module' => 'Leads'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td class="" type="enum" field="buying_power_c" width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['buying_power_c']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>



<?php if (is_string ( $this->_tpl_vars['fields']['buying_power_c']['options'] )): ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['buying_power_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['buying_power_c']['options']; ?>
">
<?php echo $this->_tpl_vars['fields']['buying_power_c']['options']; ?>

<?php else: ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['buying_power_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['buying_power_c']['value']; ?>
">
<?php echo $this->_tpl_vars['fields']['buying_power_c']['options'][$this->_tpl_vars['fields']['buying_power_c']['value']]; ?>
...
<td class="" type="varchar" field="primary_address_street" width='37.5%'  >
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['intended_course_of_study_c']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_INTENDED_COURSE_OF_STUDY','module' => 'Leads'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td class="" type="varchar" field="intended_course_of_study_c" width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['intended_course_of_study_c']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
...
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['intended_course_of_study_c']['name']; ?>
"><?php echo $this->_tpl_vars['fields']['intended_course_of_study_c']['value']; ?>
</span>
<?php endif; ?>
</td>
</tr>
...
<td class="" type="text" field="status_description" width='37.5%'  >
...
<td class="" type="varchar" field="refered_by" width='37.5%'  >
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['reason_c']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_REASON','module' => 'Leads'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td class="" type="enum" field="reason_c" width='37.5%' colspan='3' >
<?php if (! $this->_tpl_vars['fields']['reason_c']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
