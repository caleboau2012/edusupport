<?php /* Smarty version 2.6.11, created on 2015-11-23 17:10:27
         compiled from cache/modules/AOR_Scheduled_Reports/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'cache/modules/AOR_Scheduled_Reports/EditView.tpl', 38, false),array('modifier', 'default', 'cache/modules/AOR_Scheduled_Reports/EditView.tpl', 49, false),array('modifier', 'strip_semicolon', 'cache/modules/AOR_Scheduled_Reports/EditView.tpl', 67, false),array('modifier', 'lookup', 'cache/modules/AOR_Scheduled_Reports/EditView.tpl', 124, false),array('modifier', 'count', 'cache/modules/AOR_Scheduled_Reports/EditView.tpl', 204, false),array('function', 'sugar_include', 'cache/modules/AOR_Scheduled_Reports/EditView.tpl', 44, false),array('function', 'counter', 'cache/modules/AOR_Scheduled_Reports/EditView.tpl', 50, false),array('function', 'sugar_getimagepath', 'cache/modules/AOR_Scheduled_Reports/EditView.tpl', 53, false),array('function', 'sugar_translate', 'cache/modules/AOR_Scheduled_Reports/EditView.tpl', 56, false),array('function', 'html_options', 'cache/modules/AOR_Scheduled_Reports/EditView.tpl', 99, false),array('function', 'sugar_getjspath', 'cache/modules/AOR_Scheduled_Reports/EditView.tpl', 361, false),)), $this); ?>
...
" accessKey="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_KEY']; ?>
" class="button" onclick="SUGAR.ajaxUI.loadContent('index.php?action=index&module=AOR_Scheduled_Reports'); return false;" type="button" name="button" value="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_LABEL']; ?>
...
true, 
false, 
<?php echo '{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"aor_report_id","name":"aor_report_name"}}'; ?>
, 
"single", 
true
...
<td valign="top" id='last_run_label' width='12.5%' scope="col">
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='email_recipients_label' width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_EMAIL_RECIPIENTS','module' => 'AOR_Scheduled_Reports'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<span id='email_recipients_span'>
<?php echo $this->_tpl_vars['fields']['email_recipients']['value']; ?>
</span>
</tr>
<?php $this->_smarty_vars['capture']['tr'] = ob_get_contents();  $this->assign('tableRow', ob_get_contents());ob_end_clean();  if ($this->_tpl_vars['fieldsUsed'] > 0):  echo $this->_tpl_vars['tableRow']; ?>
...
<script type="text/javascript">
addForm(\'EditView\');addToValidate(\'EditView\', \'name\', \'name\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'AOR_Scheduled_Reports','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'date_entered_date\', \'date\', false,\'Date Created\' );
addToValidate(\'EditView\', \'date_modified_date\', \'date\', false,\'Date Modified\' );
addToValidate(\'EditView\', \'modified_user_id\', \'assigned_user_name\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED','module' => 'AOR_Scheduled_Reports','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'modified_by_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED_NAME','module' => 'AOR_Scheduled_Reports','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'created_by\', \'assigned_user_name\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'AOR_Scheduled_Reports','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'created_by_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'AOR_Scheduled_Reports','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'description\', \'text\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DESCRIPTION','module' => 'AOR_Scheduled_Reports','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'deleted\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DELETED','module' => 'AOR_Scheduled_Reports','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'schedule\', \'CronSchedule\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SCHEDULE','module' => 'AOR_Scheduled_Reports','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'last_run\', \'readonly\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_LAST_RUN','module' => 'AOR_Scheduled_Reports','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'status\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_STATUS','module' => 'AOR_Scheduled_Reports','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'email_recipients\', \'longtext\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_EMAIL_RECIPIENTS','module' => 'AOR_Scheduled_Reports','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'aor_report_name\', \'relate\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_AOR_REPORT_NAME','module' => 'AOR_Scheduled_Reports','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'aor_report_id\', \'id\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_AOR_REPORT_ID','module' => 'AOR_Scheduled_Reports','for_js' => true), $this); echo '\' );
