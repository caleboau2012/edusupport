...
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"aor_report_id","name":"aor_report_name"}}{/literal}, 
"single", 
true
...
{capture name="label" assign="label"}{sugar_translate label='LBL_LAST_RUN' module='AOR_Scheduled_Reports'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_EMAIL_RECIPIENTS' module='AOR_Scheduled_Reports'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{$fields.email_recipients.value}</span>
</tr>
{/capture}
{if $fieldsUsed > 0 }
{$tableRow}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_DESCRIPTION' module='AOR_Scheduled_Reports'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
<script type="text/javascript">
addForm('EditView');addToValidate('EditView', 'name', 'name', true,'{/literal}{sugar_translate label='LBL_NAME' module='AOR_Scheduled_Reports' for_js=true}{literal}' );
addToValidate('EditView', 'date_entered_date', 'date', false,'Date Created' );
addToValidate('EditView', 'date_modified_date', 'date', false,'Date Modified' );
addToValidate('EditView', 'modified_user_id', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_MODIFIED' module='AOR_Scheduled_Reports' for_js=true}{literal}' );
addToValidate('EditView', 'modified_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_MODIFIED_NAME' module='AOR_Scheduled_Reports' for_js=true}{literal}' );
addToValidate('EditView', 'created_by', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_CREATED' module='AOR_Scheduled_Reports' for_js=true}{literal}' );
addToValidate('EditView', 'created_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_CREATED' module='AOR_Scheduled_Reports' for_js=true}{literal}' );
addToValidate('EditView', 'description', 'text', false,'{/literal}{sugar_translate label='LBL_DESCRIPTION' module='AOR_Scheduled_Reports' for_js=true}{literal}' );
addToValidate('EditView', 'deleted', 'bool', false,'{/literal}{sugar_translate label='LBL_DELETED' module='AOR_Scheduled_Reports' for_js=true}{literal}' );
addToValidate('EditView', 'schedule', 'CronSchedule', true,'{/literal}{sugar_translate label='LBL_SCHEDULE' module='AOR_Scheduled_Reports' for_js=true}{literal}' );
addToValidate('EditView', 'last_run', 'readonly', false,'{/literal}{sugar_translate label='LBL_LAST_RUN' module='AOR_Scheduled_Reports' for_js=true}{literal}' );
addToValidate('EditView', 'status', 'enum', false,'{/literal}{sugar_translate label='LBL_STATUS' module='AOR_Scheduled_Reports' for_js=true}{literal}' );
addToValidate('EditView', 'email_recipients', 'longtext', false,'{/literal}{sugar_translate label='LBL_EMAIL_RECIPIENTS' module='AOR_Scheduled_Reports' for_js=true}{literal}' );
addToValidate('EditView', 'aor_report_name', 'relate', true,'{/literal}{sugar_translate label='LBL_AOR_REPORT_NAME' module='AOR_Scheduled_Reports' for_js=true}{literal}' );
addToValidate('EditView', 'aor_report_id', 'id', false,'{/literal}{sugar_translate label='LBL_AOR_REPORT_ID' module='AOR_Scheduled_Reports' for_js=true}{literal}' );
addToValidateBinaryDependency('EditView', 'assigned_user_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='AOR_Scheduled_Reports' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_ASSIGNED_TO' module='AOR_Scheduled_Reports' for_js=true}{literal}', 'assigned_user_id' );
addToValidateBinaryDependency('EditView', 'aor_report_name', 'alpha', true,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='AOR_Scheduled_Reports' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_AOR_REPORT_NAME' module='AOR_Scheduled_Reports' for_js=true}{literal}', 'aor_report_id' );
