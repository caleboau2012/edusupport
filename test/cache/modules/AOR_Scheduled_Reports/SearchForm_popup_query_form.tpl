...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<label for='name_advanced'>{sugar_translate label='LBL_NAME' module='AOR_Scheduled_Reports'}</label>
		</td>
...
<input type='text' name='{$fields.name_advanced.name}' 
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='email_advanced'>{sugar_translate label='LBL_ANY_EMAIL' module='AOR_Scheduled_Reports'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
...
<input type='text' name='{$fields.email_advanced.name}' 
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='aor_reports_name_advanced'>{sugar_translate label='LBL_AOR_REPORTS_FROM_AOR_REPORTS_TITLE' module='AOR_Scheduled_Reports'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
<input type="text" name="{$fields.aor_reports_name_advanced.name}"  class="sqsEnabled"   id="{$fields.aor_reports_name_advanced.name}" size="" value="{$fields.aor_reports_name_advanced.value}" title='' autocomplete="off"  >
<input type="hidden"  id="{$fields..name}" value="{$fields..value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.aor_reports_name_advanced.name}"   title="{$APP.LBL_SELECT_BUTTON_TITLE}" class="button firstChild" value="{$APP.LBL_SELECT_BUTTON_LABEL}" onclick='open_popup("{$fields.aor_reports_name_advanced.module}", 600, 400, "", true, false, {literal}{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":null,"name":"aor_reports_name_advanced"}}{/literal}, "single", true);'>{sugar_getimage alt=$app_strings.LBL_ID_FF_SELECT name="id-ff-select" ext=".png" other_attributes=''}</button><button type="button" name="btn_clr_{$fields.aor_reports_name_advanced.name}"   title="{$APP.LBL_CLEAR_BUTTON_TITLE}" class="button lastChild" onclick="this.form.{$fields.aor_reports_name_advanced.name}.value = ''; this.form.{$fields..name}.value = '';" value="{$APP.LBL_CLEAR_BUTTON_LABEL}">{sugar_getimage name="id-ff-clear" alt=$app_strings.LBL_ID_FF_CLEAR ext=".png" other_attributes=''}</button>
</span>
