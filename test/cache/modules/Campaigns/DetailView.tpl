...
<li><a id="tab0" href="javascript:void(0)"><em>{sugar_translate label='LBL_CAMPAIGN_INFORMATION' module='Campaigns'}</em></a></li>

<li><a id="tab1" href="javascript:void(0)"><em>{sugar_translate label='LBL_NAVIGATION_MENU_GEN2' module='Campaigns'}</em></a></li>

<li><a id="tab2" href="javascript:void(0)"><em>{sugar_translate label='LBL_PANEL_ASSIGNMENT' module='Campaigns'}</em></a></li>
</ul>
...
{counter name="panelFieldCount" start=0 print=false assign="panelFieldCount"}
<table id='LBL_NAVIGATION_MENU_GEN2' class="panelContainer" cellspacing='{$gridline}'>
{counter name="fieldsUsed" start=0 print=false assign="fieldsUsed"}
{counter name="fieldsHidden" start=0 print=false assign="fieldsHidden"}
{capture name="tr" assign="tableRow"}
<tr>
