...
<li><a id="tab0" href="javascript:void(0)"><em>{sugar_translate label='LBL_CASE_INFORMATION' module='Cases'}</em></a></li>
...
<table id='LBL_AOP_CASE_UPDATES' class="panelContainer" cellspacing='{$gridline}'>
{counter name="fieldsUsed" start=0 print=false assign="fieldsUsed"}
{counter name="fieldsHidden" start=0 print=false assign="fieldsHidden"}
{capture name="tr" assign="tableRow"}
<tr>
...
{if $panelFieldCount == 0}
<script>document.getElementById("LBL_AOP_CASE_UPDATES").style.display='none';</script>
{/if}
</div>
</div>
</div>
