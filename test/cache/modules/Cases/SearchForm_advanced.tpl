...
{html_options id='type_advanced' name='type_advanced[]' options=$fields.type_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.type_advanced.value}
   	   	</td>
