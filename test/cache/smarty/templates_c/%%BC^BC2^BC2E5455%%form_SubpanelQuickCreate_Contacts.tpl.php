<?php /* Smarty version 2.6.11, created on 2015-06-16 09:59:37
...
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'photo\', \'image\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PHOTO','module' => 'Contacts','for_js' => true), $this); echo '\' );
...
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'e_invite_status_fields\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CONT_INVITE_STATUS','module' => 'Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'event_status_name\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_LIST_INVITE_STATUS_EVENT','module' => 'Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'event_invite_id\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_LIST_INVITE_STATUS','module' => 'Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'e_accept_status_fields\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CONT_ACCEPT_STATUS','module' => 'Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'event_accept_status\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_LIST_ACCEPT_STATUS_EVENT','module' => 'Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'event_status_id\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_LIST_ACCEPT_STATUS','module' => 'Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'joomla_account_id\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_JOOMLA_ACCOUNT_ID','module' => 'Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'portal_account_disabled\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PORTAL_ACCOUNT_DISABLED','module' => 'Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'joomla_account_access\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_JOOMLA_ACCOUNT_ACCESS','module' => 'Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'portal_user_type\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PORTAL_USER_TYPE','module' => 'Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'jjwg_maps_address_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_JJWG_MAPS_ADDRESS','module' => 'Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'jjwg_maps_geocode_status_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_JJWG_MAPS_GEOCODE_STATUS','module' => 'Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'jjwg_maps_lat_c\', \'float\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_JJWG_MAPS_LAT','module' => 'Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'jjwg_maps_lng_c\', \'float\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_JJWG_MAPS_LNG','module' => 'Contacts','for_js' => true), $this); echo '\' );
