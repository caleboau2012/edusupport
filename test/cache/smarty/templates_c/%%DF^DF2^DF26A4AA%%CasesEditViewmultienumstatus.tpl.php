<?php /* Smarty version 2.6.11, created on 2015-08-26 02:49:46
         compiled from cache/modules/AOW_WorkFlow/CasesEditViewmultienumstatus.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'multienum_to_array', 'cache/modules/AOW_WorkFlow/CasesEditViewmultienumstatus.tpl', 7, false),array('function', 'html_options', 'cache/modules/AOW_WorkFlow/CasesEditViewmultienumstatus.tpl', 12, false),array('function', 'sugar_getimagepath', 'cache/modules/AOW_WorkFlow/CasesEditViewmultienumstatus.tpl', 41, false),array('modifier', 'count', 'cache/modules/AOW_WorkFlow/CasesEditViewmultienumstatus.tpl', 79, false),)), $this); ?>
...
_multiselect" value="true">
		...
		<select style='display:none' id="<?php echo $this->_tpl_vars['fields']['status']['name']; ?>
"
		name="<?php echo $this->_tpl_vars['fields']['status']['name']; ?>
[]"
		multiple="true" size='6' style="width:150" title='' tabindex="1"  
...
.minQLen<?php echo ' == 0){
		    ...
		    function updateTextOnInterval(){
		    	if (document.activeElement != document.getElementById("';  echo $this->_tpl_vars['fields']['status']['name']; ?>
-input<?php echo '"))
